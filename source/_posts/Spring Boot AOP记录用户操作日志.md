...
categories: java
toc: true
description: 在Spring框架中，使用AOP配合自定义注解可以方便的实现用户操作的监控。
tags: 
  - springboot
  - aop
  - 面向切面编程
...
# 1.依赖
在Spring框架中，使用AOP配合自定义注解可以方便的实现用户操作的监控。首先搭建一个基本的Spring Boot Web环境[开启Spring Boot](https://mrbird.cc/开启Spring-Boot.html)，然后引入必要依赖：
...
![20200715_08572379](https://nohurry-imgbed.oss-cn-qingdao.aliyuncs.com/imgs/202404031627200.png)
